...
This docs set stays small and practical. Start here if you want to understand what Workroot is, how to use it, how to develop on it, and how releases work.
...
cargo run -- run my-app my-feature -- make test
